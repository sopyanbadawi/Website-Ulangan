    ...
    <div class="grid grid-cols-1 gap-6">
        <div class="bg-white border border-gray-200 shadow-2xs rounded-xl p-6">
            <form action="{{ route('admin.kelas.store') }}" method="POST" class="space-y-4">
                ...
                {{-- Nama Kelas --}}
                <div>
                    <label for="nama_kelas" class="block text-sm font-medium mb-2">Nama Kelas</label>
                    ...
                    border {{ $errors->has('nama_kelas') ? 'border-red-500 focus:border-red-500 focus:ring-red-500' : 'border-gray-200 focus:border-blue-500 focus:ring-blue-500' }}"
